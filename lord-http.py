copy this script and make a file with formate xxxx.py
...
BIND_ADDR = ‘127.0.0.1’
BIND_PORT = 8888
PROXT_ADDR = ‘212.23.97.153’
PROXY_PORT = 80
PAYLOAD = ‘CONNECT [host_port] HTTP/1.1[crlf]Host: login.o2online.de[crlf]X-Online-Host: login.o2online.de[crlf]Connection: Keep-Alive[crlf][crlf]’
